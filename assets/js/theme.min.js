...
if (function(t, e) {
    ...
    J.fn = J.prototype = {
        ...
        var t, e, i, n, o, s, a = arguments[0] || {}, r = 1,
            l = arguments.length,
            c = !1;
    ...
    if (s)
        ...
        var f = s.csstransforms3d ? {
            ...
            scale: function(t) {
                ...
                var o, s, a = e.data(t, "isoTransform") || {}, r = {}, l = {};
                r[i] = n, e.extend(a, r);
...
function() {
    ...
    var n = i.helpers = {}, o = n.each = function(t, e, i) {
        ...
        u = n.noop = function() {}, d = n.uid = function() {
            var t = 0;
            return function() {
                return "chart-" + t++
            }
...
function(t, e) {
    ...
    function n(t, n, o, s, a) {
        ...
        return n.css("float", "left").each(function() {
            ...
            h.push(o / n),
            n > s ? (c.push(s), d.push(!1)) : a && a > n ? (c.push(a), d.push(!0)) : (c.push(n), d.push(!1))
        }).each(function(t) {
            var n, s = e(this),
                a = 0,
                r = 1;
